...
The 10 benchmark parts (P1–P10, sharing prompts with [earthtojake/text-to-cad](https://github.com/earthtojake/text-to-cad)) and the articulable print-in-place demo below were each generated by MAC. Original prompts are in [qwen3.7_token.md](qwen3.7_token.md).
